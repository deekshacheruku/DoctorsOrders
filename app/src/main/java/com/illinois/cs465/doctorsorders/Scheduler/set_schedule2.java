...
public class set_schedule2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textView = findViewById(R.id.daysNum);

        ImageButton incrementButton = findViewById(R.id.incrementBtn);
        incrementButton.setOnClickListener(view -> {
            dose++;
            textView.setText("" + dose);
        });

        ImageButton decrementButton = findViewById(R.id.decrementBtn);
        ...
        Button button = findViewById(R.id.next_to_confirm);
